> this final example based on fastify framework, put all JSNSD exam contents together
...
# fastify-sensible fastify-http-proxy fastify-reply-from got point-to-view handlebars hn-latest-stream fastify-static
```
